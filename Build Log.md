# RC Plane Build Log
Just for tracking changes to files
##  10/03/26:
...
ToDo: Need to add motor control code using HW PWM for servos and motors and cleaning up both programs since they're kinda messy.
